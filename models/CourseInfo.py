...
class CourseInfo:
    def __init__(
        ...
        # Assign values that shouldn't be changed
        ...
        # Divide name into first, second and middle
        ...
        # Divide price into rubles and cents (copeikas)
        # TODO: create method to divide float as it's used 3 times
        ...
        # Divide reward into rubles and cents (copeikas)
        # TODO: create method to divide float as it's used 3 times
        ...
        # Divide insurance into rubles and cents (copeikas)
        # TODO: create method to divide float as it's used 3 times
        ...
        # ITN and INILA numbers have to be splitted by digits
        # TODO: itn_n fields are not necessary. Use ITN.split('')[n] instead.
